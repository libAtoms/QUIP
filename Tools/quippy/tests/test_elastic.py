...
if hasattr(quippy, 'Potential') and got_scipy:
   ...
   class TestElasticFieldsCubic(QuippyTestCase):
      ...
      def setUp(self):
         ...
         # Use unrelaxed elastic constants since we're not going to minimise cell after each test deformation
      ...
      def check_strain(self, pattern):
         ...
         elastic_fields(at, a=self.a, cij=self.C)
         ...
         for i in frange(at.n):
            ...
            self.assertArrayAlmostEqual(stress_i, dot(self.C,applied_strain))
      ...
      def test1(self):
         self.check_strain([1,0,0,0,0,0])

      def test2(self):
         self.check_strain([0,1,0,0,0,0])

      def test3(self):
         self.check_strain([0,0,1,0,0,0])

      def test4(self):
         self.check_strain([0,0,0,1,0,0])

      def test5(self):
         self.check_strain([0,0,0,0,1,0])

      def test6(self):
         self.check_strain([0,0,0,0,0,1])

      def test14(self):
         self.check_strain([1,0,0,1,0,0])

      def test15(self):
         self.check_strain([1,0,0,0,1,0])

      def test16(self):
         self.check_strain([1,0,0,0,0,1])
