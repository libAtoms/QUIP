...
p.add_option('--minim-do-pos', action='store', type='bool', help="If true, relax positions in initial minimisations", default=True)
p.add_option('--minim-do-lat', action='store', type='bool', help="If true, relax lattice in initial minimisations", default=False)
