...
contains
  ...
  subroutine register_cli_params(cli_params, initial, infilename, infile_is_list, outfilename, commandfilename, &
    ...
    if (initial) then
      ...
      call param_register(cli_params, 'do_distance_dependence', 'F', do_distance_dependence)
      call param_register(cli_params, 'nth_snapshots', '1', nth_snapshots)
      call param_register(cli_params, 'angle_sigma', '0.0', gaussian_angle_sigma)
      call param_register(cli_params, 'sampling_sigma', '0.0', sampling_sigma)
      ...
      call param_register(cli_params, 'do_distance_dependence', ""//do_distance_dependence, do_distance_dependence)
      call param_register(cli_params, 'nth_snapshots', ""//nth_snapshots, nth_snapshots)
      call param_register(cli_params, 'angle_sigma', ""//gaussian_angle_sigma, gaussian_angle_sigma)
      call param_register(cli_params, 'sampling_sigma', ""//sampling_sigma, sampling_sigma)
