...
!  call verbosity_push(NORMAL)
  ...
  call param_register(cli_params,"silica_atoms",'0', silica_atoms) !number of silica atoms not to be moved
  call param_register(cli_params,"atom1_point",PARAM_MANDATORY, atom1_point)
  call param_register(cli_params,"atom2_vector",PARAM_MANDATORY, atom2_vector)
  call param_register(cli_params,"atom3_plane",PARAM_MANDATORY, atom3_plane)
  call param_register(cli_params, 'atom1_pos', '(/0.0 0.0 0.0/)', atom1_pos)
  call param_register(cli_params, 'atom12_vector', PARAM_MANDATORY, atom12_vector)
  call param_register(cli_params, 'atom123_plane_point', PARAM_MANDATORY, atom123_plane_point)
  call param_register(cli_params,"exclusion","0.0_dp", exclusion)
  call param_register(cli_params,"rotation1_sign",'1', rotation_sign1)
  call param_register(cli_params,"rotation2_sign",'1', rotation_sign2)
