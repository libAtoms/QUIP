...
program RDFD
    ...
    call param_register(params_in, 'AtomMask1', param_mandatory, mask1)
    call param_register(params_in, 'AtomMask2', param_mandatory, mask2)
    call param_register(params_in, 'centre', '0. 0. 0.', centre)
    call param_register(params_in, 'RDFCutoff', param_mandatory, rdf_cutoff)
    call param_register(params_in, 'RDFBinWidth', param_mandatory, rdf_binwidth)
    call param_register(params_in, 'DistCutoff', param_mandatory, d_cutoff)
    call param_register(params_in, 'DistBinWidth', param_mandatory, d_binwidth)
