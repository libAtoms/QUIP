...
load millennium_data.out;
methods = 13;
n = size(millennium_data,1);
i = 1;

Ruth83 = millennium_data(i:methods:n,:); i=i+1;
Schlier98_6a = millennium_data(i:methods:n,:); i=i+1;
Tsitouras99 = millennium_data(i:methods:n,:); i=i+1;

Calvo93 = millennium_data(i:methods:n,:); i=i+1;
Schlier00_6b = millennium_data(i:methods:n,:); i=i+1;
Schlier00_8b = millennium_data(i:methods:n,:); i=i+1;
Schlier00_8c = millennium_data(i:methods:n,:); i=i+1;

rk4 = millennium_data(i:methods:n,:); i=i+1;
gear4 = millennium_data(i:methods:n,:); i=i+1;
gear5 = millennium_data(i:methods:n,:); i=i+1;
gear6 = millennium_data(i:methods:n,:); i=i+1;
gear7 = millennium_data(i:methods:n,:); i=i+1;
gear8 = millennium_data(i:methods:n,:); i=i+1;
...
title ([ 'Integration of 1000 periods of ' ...
         'Kepler orbitals with eccentricity 0.5' ]);
set (gca, 'XTick', [150 200:100:1000 1200:200:2000] );
axis ([150 2000 1e-8 5]);
print -depsc millennium_a.eps;
...
title ([ 'Integration of 1000 periods of ' ...
         'Kepler orbitals with eccentricity 0.5' ]);
set (gca, 'XTick', [150 200:100:1000 1200:200:2000] );
axis ([150 2000 1e-15 1]);

print -depsc millennium_b.eps;
