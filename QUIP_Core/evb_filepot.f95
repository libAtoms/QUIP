...
program EVB_filepot_template
  ...
  implicit none
    ...
    call param_register(cli_params,"pos","", posfilename)
    call param_register(cli_params,"xyz_template","", xyz_template_filename)
    call param_register(cli_params,"out","", outfilename)
    call param_register(cli_params,"only_GAP","F", only_gap)
    call param_register(cli_params,"psf_file1","", psf_file1)
    call param_register(cli_params,"psf_file2","", psf_file2)
    call param_register(cli_params,"filepot_program","", filepot_program)
    call param_register(cli_params,"cp2k_calc_args","", cp2k_calc_args)
    call param_register(cli_params,"param_file","evb_params.dat", evb_params_filename)
    ...
    if (len_trim(evb_params_line)>0) then
       ...
       call param_register(params,"pos",""//trim(posfilename), posfilename)
       call param_register(params,"xyz_template",""//trim(xyz_template_filename), xyz_template_filename)
       call param_register(params,"out",""//trim(outfilename), outfilename)
       call param_register(params,"only_GAP",""//only_gap, only_gap)
       call param_register(params,"psf_file1",""//trim(psf_file1), psf_file1)
       call param_register(params,"psf_file2",""//trim(psf_file2), psf_file2)
       call param_register(params,"filepot_program",""//trim(filepot_program), filepot_program)
       call param_register(params,"cp2k_calc_args",""//trim(cp2k_calc_args), cp2k_calc_args)
       call param_register(params, 'mm_args_str', "", mm_args_str)
       call param_register(params, 'topology_suffix1', "_EVB1", topology_suffix1)
       call param_register(params, 'topology_suffix2', "_EVB2", topology_suffix2)
       call param_register(params, 'form_bond', '0 0', form_bond)
       call param_register(params, 'break_bond', '0 0', break_bond)
       call param_register(params, 'diagonal_dE2', '0.0', diagonal_dE2)
       call param_register(params, 'offdiagonal_A12', '0.0', offdiagonal_A12)
       call param_register(params, 'offdiagonal_mu12', '0.0', offdiagonal_mu12)
       call param_register(params, 'save_forces', "T", save_forces)
       call param_register(params, 'save_energy', 'T', save_energy)
