...
subroutine yukawa_charges(at, charge, cutoff_coulomb, yukalpha, yuksmoothlength, &
   ...
   !$omp parallel default(none) shared(mpi, charge, at, e, local_e, f, virial, efield) private(i, j, m, r_ij, u_ij, zv2, gamjir, gamjir3, gamjir2, fc, dfc_dr, de, dforce, expfactor, i_is_min_image, j_is_min_image, private_virial, private_e, private_f, private_local_e, private_efield)
