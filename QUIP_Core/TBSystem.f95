...
subroutine Self_Consistency_set_type_str(this, args_str)
  ...
  call param_register(params, 'SCF_LOCAL_U', 'F', is_SCF(SCF_LOCAL_U))
  call param_register(params, 'SCF_NONLOCAL_U_DFTB', 'F', is_SCF(SCF_NONLOCAL_U_DFTB))
  call param_register(params, 'SCF_NONLOCAL_U_NRL_TB', 'F', is_SCF(SCF_NONLOCAL_U_NRL_TB))
  call param_register(params, 'SCF_GLOBAL_U', 'F', is_SCF(SCF_GLOBAL_U))
  call param_register(params, 'SCF_LCN', 'F', is_SCF(SCF_LCN))
  call param_register(params, 'SCF_GCN', 'F', is_SCF(SCF_GCN))
  call param_register(params, 'SCF_SPIN_DIR', 'F', is_SCF(SCF_SPIN_DIR))
  call param_register(params, 'SCF_SPIN_STONER', 'F', is_SCF(SCF_SPIN_STONER))
  call param_register(params, 'GLOBAL_U', '-1.0', global_U)
