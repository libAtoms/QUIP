...
implicit none
  ...
  call param_register(cli_params, 'cij_dx', '0.001', cij_dx, help_string="Cartesian displacement size to use for elastic constant calculations")
  ...
  call param_register(cli_params, 'phonons_dx', '0.001', phonons_dx, help_string="Cartesian displacement size to use for phonon calculations")
