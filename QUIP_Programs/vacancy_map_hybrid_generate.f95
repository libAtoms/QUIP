...
implicit none
  ...
  call param_register(cli_params, "core_qm", "T", core_qm)
  call param_register(cli_params, "buffer_hops", "1", buffer_hops)
  call param_register(cli_params, "core_qm_x", "10.0", core_qm_x)
  call param_register(cli_params, "core_qm_z", "5.0", core_qm_z)
  call param_register(cli_params, "vac_qm", "F", vac_qm)
  call param_register(cli_params, "vac_qm_hops", "1", vac_qm_hops)
  call param_register(cli_params, "n_supercell", "4", n_supercell)
  call param_register(cli_params, "imin", "0", imin)
