...
${MPIRUN} $bindir/md verbosity=INVESTIGATE pot_init_args='{IP SW}' param_filename=${QUIP_ROOT}/share/Parameters/ip.parms.SW.xml trajectory_filename=${TEST}.traj.xyz T=1500.0 dt=1.0 N_steps=10 rng_seed=2065775975 < ${TEST}.in.xyz > ${TEST}.out.raw
