      ...
      lambda="21.0" gamma="1.20" eps="2.3" />
        ...
        def test_extrap_10_steps(self):
            ...
            self.assertArrayAlmostEqual(extrap_force_err, [[ 0.00032825,  0.00179226],
                                                           [ 0.00032781,  0.00229829],
                                                           [ 0.00034314,  0.00421479],
                                                           [ 0.00039979,  0.00706299],
                                                           [ 0.00051402,  0.01081147],
                                                           [ 0.00068498,  0.01541899],
                                                           [ 0.00090494,  0.02083509],
                                                           [ 0.0011667 ,  0.02700075],
                                                           [ 0.00146456,  0.03384916],
                                                           [ 0.00179378,  0.04130656]])
            self.assertArrayAlmostEqual(interp_force_err, [[ 0.00032825,  0.00179226],
                                                           [ 0.0003675 ,  0.00490662],
                                                           [ 0.00043828,  0.0074995 ],
                                                           [ 0.00049711,  0.00924518],
                                                           [ 0.00052894,  0.01017131],
                                                           [ 0.00052948,  0.01031347],
                                                           [ 0.00049851,  0.00971489],
                                                           [ 0.00043801,  0.0084262 ],
                                                           [ 0.00035217,  0.00650506],
                                                           [ 0.00025062,  0.00401577]])
        ...
        def test_extrap_2_cycles_5_steps(self):
            ...
            self.assertArrayAlmostEqual(interp_force_err_1, [[ 0.00032825,  0.00179226],
                                                             [ 0.00033528,  0.00310031],
                                                             [ 0.00034133,  0.00388554],
                                                             [ 0.00033204,  0.00382102],
                                                             [ 0.00030716,  0.00293325]])
            self.assertArrayAlmostEqual(extrap_force_err_2, [[ 0.00028088,  0.00151502],
                                                             [ 0.00035584,  0.00652692],
                                                             [ 0.0005681 ,  0.01265399],
                                                             [ 0.00084782,  0.01945557],
                                                             [ 0.00116844,  0.02685846]])
