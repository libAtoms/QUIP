...
contains
  ...
  subroutine e0_avg_from_xyz(at_file, do_ewald, do_ewald_corr, z_eff, core,r_cut,e0)
    ...
    if( core%do_core ) call Initialise(core_pot, core%ip_args, param_str=core%quip_string)
...
program teach_sparse
  ...
  real(dp) :: r_cut, z0, e0, f0, sgm(3), dlt, theta_fac, mem_required, mem_total, mem_free
  ...
  call param_register(params, 'theta_fac', '1.5', theta_fac)
  ...
  call param_register(params, 'do_ewald_corr', 'T', do_ewald_corr)
