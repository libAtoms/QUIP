...
program teach_sparse_program
  ...
  call param_register(params, 'f0', '0.0', main_teach_sparse%f0, has_value_target = has_f0)
  call param_register(params, 'sgm', '0.1 0.1 0.1', main_teach_sparse%sgm)
  call param_register(params, 'dlt', '1.0', main_teach_sparse%dlt)
  call param_register(params, 'theta_file', '', theta_file, has_value_target = has_theta_file)
  ...
  call param_register(params, 'bispectrum_file', '', bispectrum_file, has_value_target = has_bispectrum_file)
