...
module IPModel_BornMayer_module
  ...
  use error_module
  use system_module, only : dp, inoutput, print, PRINT_VERBOSE, PRINT_INVESTIGATE, current_verbosity, operator(//)
...
contains
  ...
  subroutine IPModel_BornMayer_Calc(this, at, e, local_e, f, virial, local_virial, args_str, mpi, error)
    ...
    do i=1, at%N
       ...
       if (current_verbosity() >= PRINT_INVESTIGATE) call print ("IPModel_BornMayer_Calc i " // i // " " // n_neighbours(at,i), PRINT_INVESTIGATE)
       ...
       do ji=1, n_neigh_i
          ...
          if (current_verbosity() >= PRINT_INVESTIGATE) call print ("IPModel_BornMayer_Calc i j " // i // " " // j, PRINT_INVESTIGATE)
