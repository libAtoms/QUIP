...
!      call print("raw evecs_block", PRINT_INVESTIGATE)
!      call print(evecs_block, PRINT_INVESTIGATE)
!
...
!      end do
!
!      call print("orthogonalized evecs_block", PRINT_INVESTIGATE)
!      call print(evecs_block, PRINT_INVESTIGATE)
!
!      P = 0.0_dp
!      iter = 1
...
!	end do
!
!	call print("R", PRINT_INVESTIGATE)
!	call print(R, PRINT_INVESTIGATE)
!
...
!	  endif
!
!          call print("W", PRINT_INVESTIGATE)
!          call print(W, PRINT_INVESTIGATE)
!
...
!	  end do
!
!	  call print("orthogonalized W", PRINT_INVESTIGATE)
!	  call print(W, PRINT_INVESTIGATE)
!
!	  call print("P", PRINT_INVESTIGATE)
!	  call print(P, PRINT_INVESTIGATE)
!
...
!
!
!	  call print("RR_basis", PRINT_INVESTIGATE)
!	  call print(RR_basis, PRINT_INVESTIGATE)
!
...
!	      call print("RR_evecs", PRINT_INVESTIGATE)
!	      call print(RR_evecs(1:2*block_size,1:2*block_size), PRINT_INVESTIGATE)
!	  else
